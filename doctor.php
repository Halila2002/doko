<?php
require 'bdd.php';
$donnees = $connexion->query("SELECT * FROM docteur");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Agent de santé </h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Accueil</a></li>
                    <li class="breadcrumb-item active text-primary">Agent de santé</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
<style>
    ...
    .btn{
        ...
        <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="sub-style">
                        <h4 class="sub-title px-3 mb-0">Agent de santé</h4>
                    </div>
                    <h3 class="display-7 mb-4"> Découvrez les professionnels de la santé.</h3>
            ...
            <div class="container-fluid mt-4" style="padding-left: 2; padding-right: 2;">
                ...
                <?php
                    ...
                    while ($row = $donnees->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo '<a href="prendre_rendez_vous.php?id='. $row['doctor_id'] . '" class="btn btn-primary">Prendre un rendez-vous</a>';
